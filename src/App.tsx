...
export default function App() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#1a1a1a] flex items-center justify-center p-1 sm:p-8 font-sans select-none overflow-hidden">
      ...
      <div className="w-full max-w-5xl max-h-[95dvh] sm:max-h-none aspect-[1.6/1] sm:aspect-[1.8/1] bg-[#D5D4C8] rounded-2xl sm:rounded-[2rem] shadow-[inset_-5px_-5px_15px_rgba(0,0,0,0.3),5px_10px_35px_rgba(0,0,0,0.8)] relative p-2 sm:p-8 border-[3px] sm:border-4 border-[#8c1c1c] flex flex-col justify-center">
        
        {/* --- TOP HEADER (Title) --- */}
        <div className="absolute top-[3%] sm:top-10 left-1/2 -translate-x-1/2 flex items-center justify-center gap-1 sm:gap-4 w-full px-2">
           <div className="hidden sm:block w-8 sm:w-24 h-1 sm:h-[2px] bg-[#f0f0f0] opacity-80"></div>
           <h1 className="text-[#f0f0f0] text-[8px] sm:text-3xl font-black uppercase tracking-widest leading-none drop-shadow-md text-center whitespace-nowrap">
        ...
        <div className="absolute top-[2%] sm:top-22 md:top-22 lg:top-22 right-[2%] sm:right-14 md:right-14 flex flex-col gap-[2px] sm:gap-2 z-50">
            
            <div className="flex items-center justify-end cursor-pointer group" onClick={startGame}>
                <div className="w-10 sm:w-14 text-[6px] sm:text-[10px] font-bold text-[#000000] uppercase text-left leading-tight">
                  New
                </div>
                <div className="w-3 sm:w-6 h-1.5 sm:h-3 bg-[#1a1a1a] rounded-full shadow-[inset_0px_2px_4px_rgba(0,0,0,0.8)] border border-[#ffffff]/10 group-active:bg-[#333] shrink-0"></div>
            </div>
        ...
        <div className="absolute top-[4%] sm:top-10 left-[2%] sm:left-10 border-2 sm:border-4 border-[#000000] rounded-full w-6 sm:w-16 h-6 sm:h-16 flex items-center justify-center bg-[#D5D4C8] shadow-inner">
        ...
        <div className="flex-1 flex items-center justify-between mt-[10%] sm:mt-12 px-1 sm:px-0">
          ...
          {/* Left Controls (Red D-Pad) */}
          <div className="flex flex-col justify-center gap-4 sm:gap-16 h-full py-2 sm:py-8 px-1 sm:px-4 w-12 sm:w-32 shrink-0 relative translate-y-2 sm:translate-y-12">
            <div className="relative self-end">
              ...
              <button 
                ...
                className="w-8 h-8 sm:w-20 sm:h-20 bg-[#e33124] rounded-full shadow-[inset_2px_4px_10px_rgba(255,255,255,0.2),_0_5px_10px_rgba(0,0,0,0.5)] border-[1px] sm:border-4 border-[#111] cursor-pointer active:translate-y-1 transition-transform"
              ></button>
            </div>
          ...
          <div className="flex-1 w-full max-w-3xl mx-auto flex flex-col justify-center relative">
            ...
            <div className="mt-1 sm:mt-4 flex justify-center items-end">
               <div className="flex items-center gap-1 sm:gap-4">
                  ...
                  <h2 className="text-[#f0f0f0] text-[8px] sm:text-xl font-black uppercase tracking-wider leading-none mt-1 drop-shadow-md">Scientistronica</h2>
                  <div className="w-4 sm:w-16 h-[1px] sm:h-[2px] bg-[#f0f0f0] opacity-80"></div>
               </div>
            </div>
          </div>
